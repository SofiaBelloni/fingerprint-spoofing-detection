...
def k_fold_cv(features_train, labels_train, k, n=2):
    ...
    for i in range(k):
        ...
        znorm_GMM_model = GMM_classifier(znorm_train, labels_training, 1)
...
#caliLogReg_scores = caliLogReg.compute_calibration_score(caliTest)

w, b, calibration= caliLogReg.test_logreg_cali(caliTrain, caliLabelTrain, caliTest)
